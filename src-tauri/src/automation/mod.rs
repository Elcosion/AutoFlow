...
pub use types::{
    ...
    MAX_MATCH_SCALE, MAX_POLL_MS, MAX_SCALE_CANDIDATES, MAX_TEMPLATE_HEIGHT, MAX_TEMPLATE_PIXELS,
    MAX_TEMPLATE_WIDTH, MAX_VISION_OPERATIONS, MAX_WAIT_MS, MIN_MATCH_SCALE, MIN_POLL_MS,
};
